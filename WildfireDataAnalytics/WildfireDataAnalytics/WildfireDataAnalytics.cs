...
namespace WildfireData.Analytics
{
    ...
    public class WildfireDataAnalytics : TDAnalytics
    {
        public WildfireDataAnalytics(ITDConsumer consumer) : base(consumer) { }
        public WildfireDataAnalytics(ITDConsumer consumer, bool enableUuid) : base(consumer, enableUuid) { }
    }
